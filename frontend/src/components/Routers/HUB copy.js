            ...
            <table className={Style.table}>
              ...
              <tbody>
                {dataBase.map((item) => {
                  ...
                  {/*qUANDO O PEDIDO E ASSUMIR DEVE INSERIR O STATUS DA DEMANDA, 
                    
                    
                    
                    INPUTS STATUS(SE ESTIVER REPROVADO ABRIR CAMPO MOTIVO DA REPROVA), NUMERO DO CHAMADO, OBS,  
                    */}
                })}
              </tbody>
            </table>
