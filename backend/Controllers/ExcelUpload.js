...
export const setExcelAA = async (req, res) => {
  try {
    ...
    const sql = `
      INSERT INTO AA
      (ANOMES,	CANAL,	IBGE,	CIDADE,	RAZAO_SOCIAL,	PARCEIRO_LOJA,	CNPJ,	NOME,	CLASSIFICACAO,	SEGMENTO,	PRODUTO_ATUACAO,	DATA_CADASTRO,	SITUACAO,	LOGIN_NET,	TIPO,	LOGIN_CLARO,	EXECUTIVO,	COMTA,	CABEAMENTO,	FILIAL_COORDENADOR, GN,
 DATA_ATUALIZACAO, LOGIN_ATUALIZACAO)
      VALUES ?
    `;
