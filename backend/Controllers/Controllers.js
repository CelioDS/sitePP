...
-- ================= LP =================
SELECT
 CAST(ANOMES AS CHAR(6)) AS ANOMES,
 CAST(CANAL AS VARCHAR(100)) AS CANAL,
 CAST(COLABORADOR AS VARCHAR(150)) AS NOME,
 CAST(LOGIN_CLARO AS VARCHAR(60)) AS LOGIN_CLARO,
 CAST(COMTA AS VARCHAR(60)) AS COMTA,
 CAST(CABEAMENTO AS VARCHAR(60)) AS CABEAMENTO,
 CAST(LOGIN_NET AS VARCHAR(60)) AS LOGIN_NET,
 CAST(LOJA AS VARCHAR(100)) AS LOJA,
 CAST(CIDADE AS VARCHAR(100)) AS CIDADE,
 CAST(COORDENADOR AS VARCHAR(150)) AS COORDENADOR,
 CAST(STATUS AS VARCHAR(50)) AS STATUS,

 CAST(NULL AS VARCHAR(10)) AS IBGE,
 CAST(NULL AS VARCHAR(150)) AS RAZAO_SOCIAL,
 CAST(NULL AS VARCHAR(150)) AS PARCEIRO_LOJA,
 CAST(NULL AS VARCHAR(50)) AS CNPJ,
 CAST(NULL AS VARCHAR(50)) AS CLASSIFICACAO,
 CAST(NULL AS VARCHAR(50)) AS SEGMENTO,
 CAST(NULL AS VARCHAR(100)) AS PRODUTO_ATUACAO,
 CAST(NULL AS DATE) AS DATA_CADASTRO,
 CAST(NULL AS VARCHAR(50)) AS TIPO,
 CAST(NULL AS VARCHAR(150)) AS EXECUTIVO,
 CAST(NULL AS VARCHAR(100)) AS FILIAL_COORDENADOR,
 CAST(NULL AS VARCHAR(100)) AS NM_EQUIPE_VENDA,
 CAST(NULL AS VARCHAR(50)) AS GN,

 'LP' AS ORIGEM
FROM db_projetos.lp
WHERE ANOMES = (SELECT MAX(ANOMES) FROM db_projetos.lp)

UNION ALL

-- ================= AA =================
SELECT
 CAST(ANOMES AS CHAR(6)),
 CAST(CANAL AS VARCHAR(100)),
 CAST(NOME AS VARCHAR(150)),
 CAST(LOGIN_CLARO AS VARCHAR(60)),
 CAST(COMTA AS VARCHAR(60)),
 CAST(CABEAMENTO AS VARCHAR(60)),
 CAST(LOGIN_NET AS VARCHAR(60)),
 CAST(NULL AS VARCHAR(100)),
 CAST(NULL AS VARCHAR(100)),
 CAST(NULL AS VARCHAR(150)),
 CAST(SITUACAO AS VARCHAR(50)),

 CAST(IBGE AS VARCHAR(10)),
 CAST(RAZAO_SOCIAL AS VARCHAR(150)),
 CAST(PARCEIRO_LOJA AS VARCHAR(150)),
 CAST(CNPJ AS VARCHAR(50)),
 CAST(CLASSIFICACAO AS VARCHAR(50)),
 CAST(SEGMENTO AS VARCHAR(50)),
 CAST(PRODUTO_ATUACAO AS VARCHAR(100)),
 CAST(DATA_CADASTRO AS DATE),
 CAST(TIPO AS VARCHAR(50)),
 CAST(EXECUTIVO AS VARCHAR(150)),
 CAST(FILIAL_COORDENADOR AS VARCHAR(100)),
 CAST(NM_EQUIPE_VENDA AS VARCHAR(100)),
 CAST(GN AS VARCHAR(50)),

 'AA'
FROM db_projetos.aa
WHERE ANOMES = (SELECT MAX(ANOMES) FROM db_projetos.aa)
...
SELECT
 ...
 CAST(SEGMENTO AS VARCHAR(50)),
 CAST(NULL AS VARCHAR(100)),
 CAST(DATA_CADASTRO_VENDEDOR AS DATE),
...
WHERE ANOMES = (SELECT MAX(ANOMES) FROM db_projetos.pap)
...
SELECT
 ...
 CAST(NULL AS VARCHAR(100)),
 CAST(NULL AS VARCHAR(100)),
 CAST(COORDENADOR AS VARCHAR(150)),
 CAST(SITUACAO AS VARCHAR(50)),

 CAST(NULL AS VARCHAR(10)),
 CAST(RAZAO_SOCIAL AS VARCHAR(150)),
 CAST(NULL AS VARCHAR(150)),
 CAST(CNPJ_CPF AS VARCHAR(50)),
 CAST(NULL AS VARCHAR(50)),
 CAST(NULL AS VARCHAR(50)),
 CAST(NULL AS VARCHAR(100)),
 CAST(NULL AS DATE),
...
WHERE ANOMES = (SELECT MAX(ANOMES) FROM db_projetos.pme)
...
SELECT
 CAST(ANOMES AS CHAR(6)),
 CAST(CANAL AS VARCHAR(100)),
 CAST(FUNCIONARIO AS VARCHAR(150)),
 CAST(NULL AS VARCHAR(60)),
 CAST(NULL AS VARCHAR(60)),
 CAST(NULL AS VARCHAR(60)),
 CAST(LOGIN_NET AS VARCHAR(60)),
 CAST(NULL AS VARCHAR(100)),
 CAST(CIDADE AS VARCHAR(100)),
 CAST(NULL AS VARCHAR(150)),
 ...
 'EXCLUSIVOS'
FROM db_projetos.exclusivos
WHERE ANOMES = (SELECT MAX(ANOMES) FROM db_projetos.exclusivos)
...
SELECT
 CAST(ANOMES AS CHAR(6)),
 CAST(CANAL AS VARCHAR(100)),
 CAST(NOME_COLABORADOR AS VARCHAR(150)),
 CAST(NULL AS VARCHAR(60)),
 CAST(NULL AS VARCHAR(60)),
 CAST(NULL AS VARCHAR(60)),
 CAST(LOGIN_NET AS VARCHAR(60)),
 CAST(COD_PDV AS VARCHAR(100)),
 CAST(NULL AS VARCHAR(100)),
 CAST(NULL AS VARCHAR(150)),
 CAST(SITUACAO AS VARCHAR(50)),
...
WHERE ANOMES = (SELECT MAX(ANOMES) FROM db_projetos.varejo)
